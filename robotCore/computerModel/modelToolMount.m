function [ drillModel transTool2Flng ] = modelToolMount( )
...
% of intrest TO the .stl file frame.

position_flange_origin_raw=[0; -30.88; 6.44; 1]; % position of the flange origin in the tool frame
flange2toolRot=[0,pi, 0]; % rotations from the flange frame to the tool frame (XYZ)
